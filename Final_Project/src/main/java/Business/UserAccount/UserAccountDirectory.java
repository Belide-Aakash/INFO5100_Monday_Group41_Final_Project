...
public class UserAccountDirectory {
    ...
    public UserAccount userSystemAdminAuthentication(String username, String password) {
        for (UserAccount userAccount: this.userAccountList) {
            if (username.equals(userAccount.getUsername()) && password.equals(userAccount.getPassword()) && (userAccount.getUserRole() instanceof SystemAdminRole)) {
                return userAccount;
            }
        }
        return null;
