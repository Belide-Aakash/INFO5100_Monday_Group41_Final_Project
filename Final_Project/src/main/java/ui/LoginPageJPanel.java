...
public class LoginPageJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Grocery shopping-rafiki.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(lblPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 342, Short.MAX_VALUE)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        UserAccount userAccount = userAccountDirectory.userSystemAdminAuthentication(username, password);
        ...
        if (userAccount == null) {
            ...
            for(Network network : business.getNetworkList()) {
                ...
                for(Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    userAccount = enterprise.getUserAccountDir().userAuthentication(username, password);
                    if (userAccount == null) {
                        ...
                        for (Organization organization : enterprise.getOrgDir().getOrgList()) {
                            userAccount = organization.getUserAccountDir().userAuthentication(username, password);
                            if (userAccount != null) {
