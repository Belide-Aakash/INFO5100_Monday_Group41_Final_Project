...
public class CreateSupplierRequestJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form CreateSupplierRequestJPanel
     */
    public CreateSupplierRequestJPanel(JPanel userProcessContainer, SuperMarketEnterprise enterprise, UserAccount userAccount) {
        initComponents();
    ...
    private void btnCreateReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateReqActionPerformed
        ...
        MarketWorkRequest newWorkReq = new MarketWorkRequest();
