...
//    Network network;
     ...
     */
    public CustomerCartJPanel(JPanel userProcessContainer, List<SuperMarketEnterprise> supermarkets, Set<String> allProductList, UserAccount userAccount, AdvertisementCatalog custAdvList) {
        initComponents();
...
//        for(Advertisement ad : this.custAdvList.getAdvertisementList()) {
//            System.out.println(ad.getAdvName());
//        }
//        
...
//            if (ent.getEnterpriseType() == Enterprise.EnterpriseType.SuperMarket)
//        }
