...
public class ManageStockJPanel extends javax.swing.JPanel {
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        // TODO add your handling code here:
        if (!this.currentProdList.equals(new ArrayList<Stock>())) {
            JOptionPane.showMessageDialog(this, "You have to either empty your cart or place an order before going back", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
